...
//
//   // private baseUrl: string = 'http://localhost:9090/materiels';
//   // reserveMateriel(materielId: number): Observable<any> {
//   //   return this._http.post(`http://localhost:9090/materiels/${materielId}/reserve`, materielId);
//   // }
//
...
//     };
//
//     // return this._http.post(`http://localhost:9090/materiels/${materielId}/reserve`, body);
...
//     return this._http.put(`http://localhost:9090/materiels/${materielId}`, materiel);
//   }
//
//   getAllsMateriels(): Observable<any> {
//     return this._http.get('http://localhost:9090/materiels');
//   }
//
//   deleteMateriel(materielId: number): Observable<any> {
//     return this._http.delete(`http://localhost:9090/materiels/${materielId}`);
//   }
// }
